    ...
    protected void beforeExecute(Thread t, Runnable r) {
        if (r instanceof TraceRunnable) {
            ...
            try {
                ...
                LOGGER.error("[trace execute thread pool] set context error", ex);
            }
        }
        ...
        try {
            ...
            if (r instanceof TraceRunnable) {
                ...
                try {
                    ...
                    LOGGER.error("[trace execute thread pool] clear slf4j context error", ex);
                }
                try {
                    traceRunnable.clear();
                } catch (Exception ex) {
                    LOGGER.error("[trace execute thread pool] clear context error", ex);
                }
            }
        }
    }
